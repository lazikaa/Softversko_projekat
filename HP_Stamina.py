...
def draw_status_bars(screen, fighter, x, y):
    ...
    pygame.draw.rect(screen, (255, 255, 0), (x, y, HEALTH_BAR_WIDTH * health_ratio, HEALTH_BAR_HEIGHT))
    ...
    pygame.draw.line(screen, (255, 255, 255), (x + half_width, stamina_y), (x + half_width, stamina_y + STAMINA_BAR_HEIGHT), 1)
